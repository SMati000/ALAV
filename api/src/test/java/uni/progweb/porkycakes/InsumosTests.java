...
public class InsumosTests {
  ...
  void testVerInsumo() throws Exception {
    ...
    MvcResult result =
        mvc.perform(MockMvcRequestBuilders.get(BASE_ENDPOINT + "/{id}", insumo.getIdInsumo()))
            .andDo(print())
  ...
  void testEliminarInsumo() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.delete(BASE_ENDPOINT + "/{id}", insumo.getIdInsumo()))
        .andDo(print())
