...
public class TecnicosTests {
  ...
  void testGuardarTecnico() throws Exception {
    ...
    TecnicosReqDto tecnicoReq =
        TecnicosReqDto.builder().nombre("Tecnico 1").apellido("Para prueba").dni(20487238).build();
  ...
  void testEditarTecnico() throws Exception {
    ...
    Tecnicos tecnico =
        tecnicosRepo.save(
            Tecnicos.builder().nombre("Tecnico 1").apellido("Para prueba").dni(20487238).build());
  ...
  void testVerTecnico() throws Exception {
    ...
    MvcResult result =
        mvc.perform(MockMvcRequestBuilders.get(BASE_ENDPOINT + "/{id}", tecnico.getId_tecnico()))
            .andDo(print())
  ...
  void testEliminarTecnico() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.delete(BASE_ENDPOINT + "/{id}", tecnico.getId_tecnico()))
        .andDo(print())
