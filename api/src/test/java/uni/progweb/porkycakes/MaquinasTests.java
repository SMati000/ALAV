...
public class MaquinasTests {
  ...
  void testGuardarMaquina() throws Exception {
    ...
    MaquinaReqDto maquinaReq =
        MaquinaReqDto.builder()
            .modelo("Modelo 1")
            .codigo("Codigo 1")
            .area("Area 1")
    ...
    MvcResult result =
        mvc.perform(
                multipart(HttpMethod.POST, BASE_ENDPOINT)
  ...
  void testEditarMaquina() throws Exception {
    ...
    MaquinaReqDto maquinaPatch = MaquinaReqDto.builder().modelo("Modelo 2").build();
    MvcResult result =
        mvc.perform(
                multipart(HttpMethod.PATCH, BASE_ENDPOINT + "/{id}", maquina.getId())
  ...
  void testVerMaquina() throws Exception {
    ...
    MvcResult result =
        mvc.perform(MockMvcRequestBuilders.get(BASE_ENDPOINT + "/{id}", maquina.getId()))
            .andDo(print())
  ...
  void testEliminarMaquina() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.delete(BASE_ENDPOINT + "/{id}", maquina.getId()))
        .andDo(print())
  ...
  private MockMultipartFile getMaquinaReqJson(MaquinaReqDto maquinaReqDto)
